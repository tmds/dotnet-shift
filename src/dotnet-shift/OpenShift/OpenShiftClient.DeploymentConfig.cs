...
partial class OpenShiftClient : IOpenShiftClient
{
    ...
    public async Task<DeploymentConfig> ReplaceDeploymentConfigAsync(DeploymentConfig? previous, DeploymentConfig deploymentConfig, Action<DeploymentConfig, DeploymentConfig>? update, CancellationToken cancellationToken)
    {
        do
        {
            previous ??= await GetDeploymentConfigAsync(deploymentConfig.Metadata.Name, cancellationToken)
                         ?? throw CreateApiException("Resource not found.", 404, null, null, null);

            update?.Invoke(previous, deploymentConfig);

            deploymentConfig.Metadata.ResourceVersion = previous.Metadata.ResourceVersion;

            try
            {
                return await ReplaceAppsOpenshiftIoV1NamespacedDeploymentConfigAsync(deploymentConfig, deploymentConfig.Metadata.Name, Namespace);
            }
    ...
    private async Task<DeploymentConfigList> ListAppsOpenshiftIoV1NamespacedDeploymentConfigAsync(string @namespace, bool? allowWatchBookmarks = null, string? @continue = null, string? fieldSelector = null, string? labelSelector = null, int? limit = null, string? resourceVersion = null, string? resourceVersionMatch = null, int? timeoutSeconds = null, bool? watch = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/apis/apps.openshift.io/v1/namespaces/{namespace}/deploymentconfigs?");
        urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public virtual async System.Threading.Tasks.Task<DeploymentConfig> ReplaceAppsOpenshiftIoV1NamespacedDeploymentConfigAsync(DeploymentConfig body, string name, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
            throw new System.ArgumentNullException("name");
