...
partial class OpenShiftClient : IOpenShiftClient
{
    public Task<PersistentVolumeClaim?> GetPersistentVolumeClaimAsync(string name, CancellationToken cancellationToken)
        => ReadCoreV1NamespacedPersistentVolumeClaimAsync(name, Namespace, cancellationToken: cancellationToken);
    ...
    public Task<PersistentVolumeClaim> CreatePersistentVolumeClaimAsync(PersistentVolumeClaim pvc, CancellationToken cancellationToken)
        => CreateCoreV1NamespacedPersistentVolumeClaimAsync(pvc, Namespace, cancellationToken: cancellationToken);

    public Task<PersistentVolumeClaim> PatchPersistentVolumeClaimAsync(PersistentVolumeClaim pvc, CancellationToken cancellationToken)
        => PatchCoreV1NamespacedPersistentVolumeClaimAsync(pvc, pvc.Metadata.Name, Namespace, cancellationToken: cancellationToken);
    ...
    public Task<PersistentVolumeClaimList> ListPersistentVolumeClaimsAsync(string? labelSelector, CancellationToken cancellationToken)
        => ListCoreV1NamespacedPersistentVolumeClaimAsync(Namespace, labelSelector: labelSelector, cancellationToken: cancellationToken);

    public Task DeletePersistentVolumeClaimAsync(string name, CancellationToken cancellationToken)
        => DeleteCoreV1NamespacedPersistentVolumeClaimAsync(name, Namespace, cancellationToken: cancellationToken);

    private async System.Threading.Tasks.Task<PersistentVolumeClaimList> ListCoreV1NamespacedPersistentVolumeClaimAsync(string @namespace, bool? allowWatchBookmarks = null, string? @continue = null, string? fieldSelector = null, string? labelSelector = null, int? limit = null, string? resourceVersion = null, string? resourceVersionMatch = null, int? timeoutSeconds = null, bool? watch = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");

        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/namespaces/{namespace}/persistentvolumeclaims?");
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<PersistentVolumeClaimList>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    private async System.Threading.Tasks.Task<PersistentVolumeClaim> CreateCoreV1NamespacedPersistentVolumeClaimAsync(PersistentVolumeClaim body, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<PersistentVolumeClaim>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw CreateApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    private async System.Threading.Tasks.Task<Status> DeleteCoreV1CollectionNamespacedPersistentVolumeClaimAsync(string @namespace, DeleteOptions? body = null, string? @continue = null, string? dryRun = null, string? fieldSelector = null, int? gracePeriodSeconds = null, string? labelSelector = null, int? limit = null, bool? orphanDependents = null, string? propagationPolicy = null, string? resourceVersion = null, string? resourceVersionMatch = null, int? timeoutSeconds = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");
    ...
    private async System.Threading.Tasks.Task<PersistentVolumeClaim?> ReadCoreV1NamespacedPersistentVolumeClaimAsync(string name, string @namespace, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/namespaces/{namespace}/persistentvolumeclaims/{name}?");
    ...
    private async System.Threading.Tasks.Task<PersistentVolumeClaim> PatchCoreV1NamespacedPersistentVolumeClaimAsync(PersistentVolumeClaim body, string name, string @namespace, string? dryRun = null, string? fieldManager = null, bool? force = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
            throw new System.ArgumentNullException("name");
