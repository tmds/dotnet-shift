...
partial class OpenShiftClient : IOpenShiftClient
{
    ...
    public System.Threading.Tasks.Task CreateConfigMapAsync(ConfigMap configMap, CancellationToken cancellationToken)
        => CreateCoreV1NamespacedConfigMapAsync(configMap, Namespace, cancellationToken: cancellationToken);

    private async System.Threading.Tasks.Task<ConfigMap?> ReadCoreV1NamespacedConfigMapAsync(string name, string @namespace, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
    ...
    private async System.Threading.Tasks.Task<ConfigMap> CreateCoreV1NamespacedConfigMapAsync(ConfigMap body, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");
    ...
    private async System.Threading.Tasks.Task<ConfigMapList> ListCoreV1NamespacedConfigMapAsync(string @namespace, bool? allowWatchBookmarks = null, string? @continue = null, string? fieldSelector = null, string? labelSelector = null, int? limit = null, string? resourceVersion = null, string? resourceVersionMatch = null, int? timeoutSeconds = null, bool? watch = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");
