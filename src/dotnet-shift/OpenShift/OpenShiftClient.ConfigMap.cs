...
partial class OpenShiftClient : IOpenShiftClient
{
    ...
    public Task<ConfigMapList> ListConfigMapsAsync(string labelSelector, CancellationToken cancellationToken)
        => ListCoreV1NamespacedConfigMapAsync(Namespace, labelSelector: labelSelector, cancellationToken: cancellationToken);

    public Task DeleteConfigMapAsync(string name, CancellationToken cancellationToken)
        => DeleteCoreV1NamespacedConfigMapAsync(name, Namespace, cancellationToken: cancellationToken);
    ...
    private async Task<ConfigMap?> ReadCoreV1NamespacedConfigMapAsync(string name, string @namespace, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/namespaces/{namespace}/configmaps/{name}?");
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ConfigMap>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    private async Task<ConfigMap> CreateCoreV1NamespacedConfigMapAsync(ConfigMap body, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (@namespace == null)
            throw new System.ArgumentNullException("@namespace");
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/namespaces/{namespace}/configmaps?");
        urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
        if (dryRun != null)
        {
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ConfigMapList>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw CreateApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    private async Task<ConfigMap> PatchCoreV1NamespacedConfigMapAsync(ConfigMap body, string name, string @namespace, string? dryRun = null, string? fieldManager = null, bool? force = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
            throw new System.ArgumentNullException("name");
    ...
    public virtual async System.Threading.Tasks.Task<ConfigMap> ReplaceCoreV1NamespacedConfigMapAsync(ConfigMap body, string name, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
            throw new System.ArgumentNullException("name");
