...
partial class OpenShiftClient : IOpenShiftClient
{
    ...
    private async Task<ImageStream?> ReadImageOpenshiftIoV1NamespacedImageStreamAsync(string name, string @namespace, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/apis/image.openshift.io/v1/namespaces/{namespace}/imagestreams/{name}?");
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ImageStream>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    private async Task<ImageStream> CreateImageOpenshiftIoV1NamespacedImageStreamAsync(ImageStream body, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        ...
        var urlBuilder_ = new System.Text.StringBuilder();
        urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/apis/image.openshift.io/v1/namespaces/{namespace}/imagestreams?");
        urlBuilder_.Replace("{namespace}", System.Uri.EscapeDataString(ConvertToString(@namespace, System.Globalization.CultureInfo.InvariantCulture)));
        if (dryRun != null)
        {
        ...
        try
        {
            using (var request_ = new System.Net.Http.HttpRequestMessage())
            {
                ...
                try
                {
                    ...
                    if (status_ == 200)
                    {
                        var objectResponse_ = await ReadObjectResponseAsync<ImageStreamList>(response_, headers_, cancellationToken).ConfigureAwait(false);
                        if (objectResponse_.Object == null)
                        {
                            throw CreateApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                        }
    ...
    public virtual async System.Threading.Tasks.Task<ImageStream> ReplaceImageOpenshiftIoV1NamespacedImageStreamAsync(ImageStream body, string name, string @namespace, string? dryRun = null, string? fieldManager = null, string? pretty = null, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
    {
        if (name == null)
            throw new System.ArgumentNullException("name");
